package club.nezxenka.netvision.alert.internal;
...
public class AlertManager {
  ...
  private volatile club.nezxenka.netvision.redis.alert.CrossServerPublisher crossServerPublisher;

  public void setCrossServerPublisher(
      club.nezxenka.netvision.redis.alert.CrossServerPublisher publisher) {
  ...
  public void send(Component component, AlertType type) {
    ...
    club.nezxenka.netvision.redis.alert.CrossServerPublisher publisher = this.crossServerPublisher;
